...
def ensure_schema():
    ...
    schema_additions = {
        ...
        "job_application": {
            ...
            "work_arrangement": "VARCHAR(40) NOT NULL DEFAULT ''",
            "source": "VARCHAR(120) NOT NULL DEFAULT ''",
            "follow_up_date": "VARCHAR(80) NULL",
            "reminder_note": "TEXT NULL",
            "reminder_done": f"{boolean} NOT NULL DEFAULT 0",
            "rejection_reason": "VARCHAR(120) NOT NULL DEFAULT ''",
            "rejection_notes": "TEXT NULL",
            "interview_research": "TEXT NULL",
            "interview_questions": "TEXT NULL",
            "interview_answers": "TEXT NULL",
            "interview_talking_points": "TEXT NULL",
        },
        "interview_answer": {
